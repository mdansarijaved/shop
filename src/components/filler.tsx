export default function Filler() {
  ...
  return (
    <div className="mt-20">
      <h1 className="bg-gradient-to-r from-[#e0c08a] via-[#edd8ab] to-[#e0c08a] w-[80%] mx-auto py-6 text-center md:text-3xl text-xl font-semibold">
        For corporate bulk gifting enquiries, Call: 123-456-7890
      </h1>
      <div className="md:flex w-[80%] justify-between mx-auto gap-4 mt-4 items-center text-center hidden">
