  ...
  return (
    <div className="w-[80vw] h-[80vh]  mx-auto place-items-center mt-4 rounded-md overflow-clip">
      <div className="absolute z-10 flex flex-col place-items-center justify-center top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 gap-2">
        ...
        <p className="text-white font-semibold">New in from Vishwakarma Woodworks. Traditional craftmanship.</p>
        <button className="bg-gray-700/50 hover:bg-gray-700/70 px-6 py-3 mt-4 text-white border-2 border-black/30 rounded-md">Shop Products</button>
      </div>
