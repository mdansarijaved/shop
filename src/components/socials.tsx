    ...
    <div className="w-[80%] mx-auto">
      <div className=" flex justify-between border-y py-6">
        ...
        <div className="flex place-items-center">
          {icons.map((icon) => (
            <span className="hover:bg-[#f5f5f5] p-4 rounded-full cursor-pointer">
              {icon}
            </span>
          ))}
        </div>
      ...
      <Image src="/Ecomm-Logo.jpg" alt="Large Image" width={100} height={100} />
      <div className="flex text-sm gap-1 ml-2 text-[#757575]">
        <h1 className="cursor-pointer hover:text-[#764927]">Terms & Conditions</h1>
        <h1>-</h1>
        <h1 className="cursor-pointer hover:text-[#764927]">Privacy Policy</h1>
      </div>
      </div>
    </div>
  );
